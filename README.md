...
Actively in development as the core alarm, NFC, RTC, and buzzer logic working. But I plan to add an OLED display and some buttons as well for changing alarm timings and clock times.
